import { IBannerProps, MessageBarForBanner } from "./Banner";
import { IInputs, IOutputs } from "./ManifestTypes";
import * as React from "react";

export class Banner implements ComponentFramework.ReactControl<IInputs, IOutputs> {

...
namespace ECC.Core.DataContext
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="ECC.Core.DataContext.OfM_Agreement"/> entities.
		/// </summary>
		public System.Linq.IQueryable<ECC.Core.DataContext.OfM_Agreement> OfM_AgreementSet
		{
			get
			{
				return this.CreateQuery<ECC.Core.DataContext.OfM_Agreement>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="ECC.Core.DataContext.OfM_Agreement_History"/> entities.
		/// </summary>
		public System.Linq.IQueryable<ECC.Core.DataContext.OfM_Agreement_History> OfM_Agreement_HistorySet
		{
			get
			{
				return this.CreateQuery<ECC.Core.DataContext.OfM_Agreement_History>();
			}
		}

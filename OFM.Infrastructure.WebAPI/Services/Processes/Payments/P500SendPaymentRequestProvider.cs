...
public class P500SendPaymentRequestProvider : ID365ProcessProvider
{
            ...
            var fetchXml = $"""
                    <fetch version="1.0" output-format="xml-platform" mapping="logical" distinct="false">
                      <entity name="ofm_payment">
                        ...
                        <attribute name="ofm_amount_base" />
    ...
    public async Task<JsonObject> RunProcessAsync(ID365AppUserService appUserService, ID365WebApiService d365WebApiService, ProcessParameter processParams)
    {
        ...
        await CreatePayAsProcessed(appUserService, d365WebApiService, _BCCASApi.feederNumber, result);
        #endregion
    ...
    private async Task<JsonObject> CreatePayAsProcessed(ID365AppUserService appUserService, ID365WebApiService d365WebApiService,string feederNumber, string result)
    {

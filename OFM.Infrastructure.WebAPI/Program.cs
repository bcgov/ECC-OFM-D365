...
services.AddScoped<ID365ProcessProvider, P265SendFundingEnvelopeChangeApprovalNotification>();
...
services.AddScoped<ID365ProcessProvider, P410GetDBAProvider>();
services.AddScoped<ID365ProcessProvider, P415GetDBABatchProvider>();

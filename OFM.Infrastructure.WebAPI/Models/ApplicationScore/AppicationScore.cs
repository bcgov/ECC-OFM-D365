...
<link-entity name=""ccof_fee_region"" from=""ccof_fee_regionid"" to=""ofm_fee_region"" alias=""bcssa"">
                                                     <link-entity name=""ofm_school_district"" from=""ofm_fee_region"" to=""ccof_fee_regionid"" alias=""sd"">
                                                      <filter>
...
<condition attribute=""ofm_application_score_calculator"" operator=""eq"" value=""{{1}}"" />
    ...
    public class FortyPercentileThresholdFee
    {
        ...
        public string? ProgramType => _data.GetPropertyValue<string>("_ofm_childcare_category_value");
        public string? BCSSAChapter => _data.GetFormattedValue("_ofm_fee_region_value");

...
{
    public sealed class GetNotCompletePCMNum : CodeActivity
    {
        [Output("Not Complete PCM Number")]
        public OutArgument<int> pcmNum { get; set; }
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            try
            {
                ...
                this.pcmNum.Set(executionContext, pcmReviews.Entities.Count);
